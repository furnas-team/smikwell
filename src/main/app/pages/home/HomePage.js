          ...
          <div className="home__contacts-screen">
            ...
            <div>
              ...
              <a className="home__header-phone-link"
                 ...
                 onClick={this.handlePhoneClick}>
                +7(916) 4-6666-30 (есть WhatsApp, Viber, Telegram)
              </a>
